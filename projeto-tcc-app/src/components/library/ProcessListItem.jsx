...
import { Eye, Edit, Trash2, Calendar, Activity, Repeat, Flag, Users, FileText } from 'lucide-react';
      ...
      <Card className="hover:shadow-md transition-shadow duration-200">
        <CardContent className="flex justify-between items-center p-4">
          <div className="flex-1 min-w-0">
            ...
            {process.description && (
                <p className="text-sm text-muted-foreground line-clamp-1 mt-1">{process.description}</p>
            )}
          ...
          <div className="flex gap-2 ml-4 flex-shrink-0">
            <Button variant="default" size="sm" onClick={() => onEdit(process.id)}>
