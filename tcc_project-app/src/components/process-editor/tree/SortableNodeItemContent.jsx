...
export const SortableNodeItemContent = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="w-[15%] text-center text-gray-600 dark:text-gray-400 truncate px-1" title={predecessorIndices}>
        {predecessorIndices}
      </div>

      <div className="w-[15%] text-center text-gray-600 dark:text-gray-400 truncate px-1" title={node.modelInfo}>
        {node.modelInfo || '-'}
      </div>
      
      <div className="w-[15%] text-center text-gray-600 dark:text-gray-400 truncate pr-2">
        {typeDisplay}
      </div>
